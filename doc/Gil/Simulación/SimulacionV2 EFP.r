...
# From input (dat) get interpolation of censored times!
aa<-replicate(100,{
 sm<-SimulateGerminatio(Ptheta=10,Time=seq(0.1,100,by=0.01))  
 dat<-sm$sim
 data<-sm$dtorig
 germ<-GerminationTT(dat)
...
estadisticos.media(as.data.frame(t(aa))) -> media0.01
estadisticos.mediana(as.data.frame(t(aa))) -> mediana0.01
cuantiles(as.data.frame(t(aa)),prob=seq(0,1,by=0.1)) -> cuartiles0.01

# SIMULACION  
# Start of estimation procedure  
# From input (dat) get interpolation of censored times!
aa<-replicate(10,{
 sm<-SimulateGerminatio(Ptheta=100,Time=seq(0.1,100,by=0.1))  
 dat<-sm$sim
 data<-sm$dtorig
 germ<-GerminationTT(dat)
...
estadisticos.media(as.data.frame(t(aa))) -> media0.1
estadisticos.mediana(as.data.frame(t(aa))) -> mediana0.1
cuantiles(as.data.frame(t(aa)),prob=seq(0,1,by=0.1)) -> cuartiles0.1

# SIMULACION  
# Start of estimation procedure  
# From input (dat) get interpolation of censored times!
aa<-replicate(10,{
 sm<-SimulateGerminatio(Ptheta=100,Time=seq(0.1,100,by=1))  
 dat<-sm$sim
 data<-sm$dtorig
 germ<-GerminationTT(dat)
...
estadisticos.media(as.data.frame(t(aa))) -> media1
estadisticos.mediana(as.data.frame(t(aa))) -> mediana1
cuantiles(as.data.frame(t(aa)),prob=seq(0,1,by=0.1)) -> cuartiles1

# SIMULACION  
# Start of estimation procedure  
# From input (dat) get interpolation of censored times!
aa<-replicate(10,{
 sm<-SimulateGerminatio(Ptheta=100,Time=seq(0.1,100,by=10))  
 dat<-sm$sim
 data<-sm$dtorig
 germ<-GerminationTT(dat)
...
estadisticos.media(as.data.frame(t(aa))) -> media10
estadisticos.mediana(as.data.frame(t(aa))) -> mediana10
cuantiles(as.data.frame(t(aa)),prob=seq(0,1,by=0.1)) -> cuartiles10

# SIMULACION  
# Start of estimation procedure  
# From input (dat) get interpolation of censored times!
aa<-replicate(10,{
 sm<-SimulateGerminatio(Ptheta=100,Time=seq(0.1,100,by=100))  
 dat<-sm$sim
 data<-sm$dtorig
 germ<-GerminationTT(dat)
...
estadisticos.media(as.data.frame(t(aa))) -> media100
estadisticos.mediana(as.data.frame(t(aa))) -> mediana100
cuantiles(as.data.frame(t(aa)),prob=seq(0,1,by=0.1)) -> cuartiles100



media0.01 %>% write.csv("media0.01.csv")
mediana0.01 %>% write.csv("mediana0.01.csv")
cuartiles0.01 %>% write.csv("cuartiles0.01.csv")


media0.1 %>% write.csv("media0.1.csv")
mediana0.1 %>% write.csv("mediana0.1.csv")
cuartiles0.1 %>% write.csv("cuartiles0.1.csv")


media1 %>% write.csv("media1.csv")
mediana1 %>% write.csv("mediana1.csv")
cuartiles1 %>% write.csv("cuartiles1.csv")


media10 %>% write.csv("media10.csv")
mediana10 %>% write.csv("mediana10.csv")
cuartiles10 %>% write.csv("cuartiles10.csv")


media100 %>% write.csv("media100.csv")
mediana100 %>% write.csv("mediana100.csv")
cuartiles100 %>% write.csv("cuartiles100.csv")
...
# From input (dat) get interpolation of censored times!
aa<-replicate(100,{
 sm<-SimulateGerminatio(Treatments=seq(-1.6,0,by=0.2), Ptheta=10,Time=seq(0.1,30,by=0.01))  
 dat<-sm$sim
 data<-sm$dtorig
 germ<-GerminationTT(dat)
...
estadisticos.media(as.data.frame(t(aa))) -> media1.6_0.2
estadisticos.mediana(as.data.frame(t(aa))) -> mediana1.6_0.2
cuantiles(as.data.frame(t(aa)),prob=seq(0,1,by=0.1)) -> cuartiles1.6_0.2

# SIMULACION  
# Start of estimation procedure  
# From input (dat) get interpolation of censored times!
aa<-replicate(10,{
 sm<-SimulateGerminatio(Treatments=seq(-1.6,0,by=0.4), Ptheta=100,Time=seq(0.1,30,by=0.01))  
 dat<-sm$sim
 data<-sm$dtorig
 germ<-GerminationTT(dat)
...
estadisticos.media(as.data.frame(t(aa))) -> media1.6_0.4
estadisticos.mediana(as.data.frame(t(aa))) -> mediana1.6_0.4
cuantiles(as.data.frame(t(aa)),prob=seq(0,1,by=0.1)) -> cuartiles1.6_0.4

# SIMULACION  
# Start of estimation procedure  
# From input (dat) get interpolation of censored times!
aa<-replicate(10,{
 sm<-SimulateGerminatio(Treatments=seq(-1.6,0,by=0.8), Ptheta=100,Time=seq(0.1,30,by=0.01))  
 dat<-sm$sim
 data<-sm$dtorig
 germ<-GerminationTT(dat)
...
estadisticos.media(as.data.frame(t(aa))) -> media1.6_0.8
estadisticos.mediana(as.data.frame(t(aa))) -> mediana1.6_0.8
cuantiles(as.data.frame(t(aa)),prob=seq(0,1,by=0.1)) -> cuartiles1.6_0.8

# SIMULACION  
# Start of estimation procedure  
# From input (dat) get interpolation of censored times!
aa<-replicate(100,{
 sm<-SimulateGerminatio(Treatments=seq(-1,0,by=0.2), Ptheta=10,Time=seq(0.1,30,by=0.01))  
 dat<-sm$sim
 data<-sm$dtorig
 germ<-GerminationTT(dat)
...
estadisticos.media(as.data.frame(t(aa))) -> media1_0.2
estadisticos.mediana(as.data.frame(t(aa))) -> mediana1_0.2
cuantiles(as.data.frame(t(aa)),prob=seq(0,1,by=0.1)) -> cuartiles1_0.2

# SIMULACION  
# Start of estimation procedure  
# From input (dat) get interpolation of censored times!
aa<-replicate(10,{
 sm<-SimulateGerminatio(Treatments=seq(-1,0,by=0.4), Ptheta=100,Time=seq(0.1,30,by=0.01))  
 dat<-sm$sim
 data<-sm$dtorig
 germ<-GerminationTT(dat)
...
estadisticos.media(as.data.frame(t(aa))) -> media1_0.4
estadisticos.mediana(as.data.frame(t(aa))) -> mediana1_0.4
cuantiles(as.data.frame(t(aa)),prob=seq(0,1,by=0.1)) -> cuartiles1_0.4

# SIMULACION  
# Start of estimation procedure  
# From input (dat) get interpolation of censored times!
aa<-replicate(10,{
 sm<-SimulateGerminatio(Treatments=seq(-1,0,by=0.5), Ptheta=100,Time=seq(0.1,30,by=0.01))  
 dat<-sm$sim
 data<-sm$dtorig
 germ<-GerminationTT(dat)
...
estadisticos.media(as.data.frame(t(aa))) -> media1_0.5
estadisticos.mediana(as.data.frame(t(aa))) -> mediana1_0.5
cuantiles(as.data.frame(t(aa)),prob=seq(0,1,by=0.1)) -> cuartiles1_0.5

# SIMULACION  
# Start of estimation procedure  
# From input (dat) get interpolation of censored times!
aa<-replicate(100,{
 sm<-SimulateGerminatio(Treatments=seq(-3,0,by=0.2), Ptheta=10,Time=seq(0.1,30,by=0.01))  
 dat<-sm$sim
 data<-sm$dtorig
 germ<-GerminationTT(dat)
...
estadisticos.media(as.data.frame(t(aa))) -> media3_0.2
estadisticos.mediana(as.data.frame(t(aa))) -> mediana3_0.2
cuantiles(as.data.frame(t(aa)),prob=seq(0,1,by=0.1)) -> cuartiles3_0.2

# SIMULACION  
# Start of estimation procedure  
# From input (dat) get interpolation of censored times!
aa<-replicate(10,{
 sm<-SimulateGerminatio(Treatments=seq(-3,0,by=0.5), Ptheta=100,Time=seq(0.1,30,by=0.01))  
 dat<-sm$sim
 data<-sm$dtorig
 germ<-GerminationTT(dat)
...
estadisticos.media(as.data.frame(t(aa))) -> media3_0.5
estadisticos.mediana(as.data.frame(t(aa))) -> mediana3_0.5
cuantiles(as.data.frame(t(aa)),prob=seq(0,1,by=0.1)) -> cuartiles3_0.5

# SIMULACION  
# Start of estimation procedure  
# From input (dat) get interpolation of censored times!
aa<-replicate(10,{
 sm<-SimulateGerminatio(Treatments=seq(-3,0,by=1.5), Ptheta=100,Time=seq(0.1,30,by=0.01))  
 dat<-sm$sim
 data<-sm$dtorig
 germ<-GerminationTT(dat)
...
estadisticos.media(as.data.frame(t(aa))) -> media3_1.5
estadisticos.mediana(as.data.frame(t(aa))) -> mediana3_1.5
cuantiles(as.data.frame(t(aa)),prob=seq(0,1,by=0.1)) -> cuartiles3_1.5
...
media1.6_0.2 %>% write.csv("media1.6_0.2.csv")
mediana1.6_0.2 %>% write.csv("mediana1.6_0.2.csv")
cuartiles1.6_0.2 %>% write.csv("cuartiles1.6_0.2.csv")

media1.6_0.4 %>% write.csv("media1.6_0.4.csv")
mediana1.6_0.4 %>% write.csv("mediana1.6_0.4.csv")
cuartiles1.6_0.4 %>% write.csv("cuartiles1.6_0.4.csv")

media1.6_0.8 %>% write.csv("media1.6_0.8.csv")
mediana1.6_0.8 %>% write.csv("mediana1.6_0.8.csv")
cuartiles1.6_0.8 %>% write.csv("cuartiles1.6_0.8.csv")

media1_0.2 %>% write.csv("media1_0.2.csv")
mediana1_0.2 %>% write.csv("mediana1_0.2.csv")
cuartiles1_0.2 %>% write.csv("cuartiles1_0.2.csv")

media1_0.4 %>% write.csv("media1_0.4.csv")
mediana1_0.4 %>% write.csv("mediana1_0.4.csv")
cuartiles1_0.4 %>% write.csv("cuartiles1_0.4.csv")

media1_0.5 %>% write.csv("media1_0.5.csv")
mediana1_0.5 %>% write.csv("mediana1_0.5.csv")
cuartiles1_0.5 %>% write.csv("cuartiles1_0.5.csv")

media3_0.2 %>% write.csv("media3_0.2.csv")
mediana3_0.2 %>% write.csv("mediana3_0.2.csv")
cuartiles3_0.2 %>% write.csv("cuartiles3_0.2.csv")

media3_0.5 %>% write.csv("media3_0.5.csv")
mediana3_0.5 %>% write.csv("mediana3_0.5.csv")
cuartiles3_0.5 %>% write.csv("cuartiles3_0.5.csv")

media3_1.5 %>% write.csv("media3_1.5.csv")
mediana3_1.5 %>% write.csv("mediana3_1.5.csv")
cuartiles3_1.5 %>% write.csv("cuartiles3_1.5.csv")
